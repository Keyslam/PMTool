	...
	<form>
		...
		<div class="row">
			<div class="col l6">
				@if ($gameStarted)
					@if ($roundGoing)
						<button id="pause-round" class="btn waves-effect waves-light" style="width: 100%">Ronde pauzeren</button>
					@else
						<button id="start-round" class="btn waves-effect waves-light" style="width: 100%">Ronde starten</button>
					@endif
				@endif
			</div>
		</div>
		...
		<div class="row">
			<div class="col l6">
				...
				@else
					<button id="stop-game" class="btn waves-effect waves-light" style="width: 100%">Spel stoppen</button>
				@endif
			</div>
...
<script>
	$(document).ready(function () {
		...
		$("#start-round").on("click", startRound);
		$("#pause-round").on("click", pauseRound);
	})
	...
	function startRound(event) {
		...
		$.ajax({
			method: "POST",
			url: "@asset('Tournament/StartRound')",
			dataType: "json",
			data: {
				"tournamentID": $("#tournament-id").val()
			}
